...
There are a number of tutorials provided that detail how to debug PHP extensions amongst other things. See the [Tutorials](#advanced-php-and-debugging-tutorials) section.
